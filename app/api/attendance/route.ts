...
export async function GET(req: NextRequest) {
  try {
    ...
    // ====== JALUR BARU: ambil waktu CI/CO hari ini untuk teknisi + project ======
    const technicianId =
    ...
    if (technicianId) {
      // Fokus: ambil CI/CO untuk project terpilih (hari ini)
    ...
    // ====== JALUR LAMA (dipertahankan): histori attendance (dengan koordinat) ======
